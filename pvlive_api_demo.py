...
def main():
    ...
    print(pvlive.at_time(datetime(2019, 3, 18, 12, 0, tzinfo=pytz.utc), pes_id=0, dataframe=True))
    print("\nAt 2019-03-18 12:35: ")
    ...
    print(pvlive.between(datetime(2019, 3, 18, 10, 30, tzinfo=pytz.utc),
                         datetime(2019, 3, 18, 14, 00, tzinfo=pytz.utc), pes_id=0, dataframe=True))
    print("\nPeak on 2019-03-18: ")
    print(pvlive.day_peak(date(2019, 3, 18)))
    print("\nPeak on 2019-03-18 as a Pandas DataFrame object: ")
    print(pvlive.day_peak(date(2019, 3, 18), pes_id=0, dataframe=True))
    ...
    print(pvlive.latest(pes_id=22, dataframe=True))
    ...
    print(pvlive.at_time(datetime(2019, 3, 18, 12, 0, tzinfo=pytz.utc), pes_id=22, dataframe=True))
    ...
    print(pvlive.between(datetime(2019, 3, 18, 10, 30, tzinfo=pytz.utc),
                         datetime(2019, 3, 18, 14, 00, tzinfo=pytz.utc), pes_id=22, dataframe=True))
    ...
    print(pvlive.day_peak(date(2019, 3, 18), pes_id=22, dataframe=True))
