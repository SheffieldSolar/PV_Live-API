...
def main():
    ...
    print(pvlive.latest())
    print("\nAs Pandas Dataframe: ")
    print(pvlive.latest(0, dataframe=True))
    print("\nAt 2018-06-03 12:00: ")
    ...
    print(pvlive.at_time(datetime(2018, 6, 3, 12, 35, tzinfo=pytz.utc), 0, dataframe=True))
    ...
    print(pvlive.between(datetime(2018, 6, 3, 12, 20, tzinfo=pytz.utc),
                         datetime(2018, 6, 3, 14, 00, tzinfo=pytz.utc), 0, "ucl_mw,stats_error", True))
    ...
    print(pvlive.day_peak(date(2018, 6, 3), 0, "ucl_mw", True))
